...
def mix_image(back, fore, (x, y)):
    ...
    for c in range(0,3):
        ...
        fore[fy:fy+h, fx:fx+w, c] * (fore[fy:fy+h, fx:fx+w, 3]/255.0) +\
        ret[by:by+h, bx:bx+w, c] * (1.0 - fore[fy:fy+h, fx:fx+w, 3]/255.0)
